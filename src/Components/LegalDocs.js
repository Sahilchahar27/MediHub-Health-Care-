  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Medi <span className="legal-siteSign">Hub</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Medi Hub, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Medi Hub, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Medi Hub is designed to simplify healthcare access. You can choose
